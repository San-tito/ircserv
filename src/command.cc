...
/*   Updated: 2025/04/10 13:09:41 by bautrodr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void User::Execute(Client *client, const std::vector<std::string> &params)
{
	...
	{
		if (params[0].find_first_not_of("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOP"
										"QRSTUVWXYZ0123456789+-@._") != std::string::npos)
