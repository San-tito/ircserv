...
# define ERR_NOSUCHCHANNEL(target, channel) "403 " + (target) + " " + (channel) + " :No such channel"
...
# define ERR_USENOTINCHANNEL(channel, nick, target) "441 " + (channel) + " " + (nick) + " " + (target) + " :They aren't on that channel"
...
# define ERR_CHANNELISFULL(target, channel) "471 " + (target) + " " + (channel) + " :Cannot join channel (+l) -- Channel is full, try later"
