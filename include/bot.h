  ...
  public:
	static std::string getRandomJoke()
	{
		const char *raw_jokes[] = {
			...
			"You can't run through a camp site. You can only ran,
			...
			"Why did the fireman wear red, white,
				and blue suspenders? To hold his pants up.",
			...
			"I had a pair of racing snails. I removed their shells to make them more aerodynamic,
				but they became sluggish.",
			"I wanted to be a tailor but I didn't suit the job",
			"What did the father tomato say to the baby tomato whilst on a family walk? Ketchup.",
			"Wife: Honey I’m pregnant. Me: Well…. what do we do now? Wife: Well,
				I guess we should go to a baby doctor. Me: Hm.. I think I’d be a lot more comfortable going to an adult doctor.",
			"I think circles are pointless.",
			"A ghost walks into a bar and asks for a glass of vodka but the bar tender says,
